...
typedef	enum		SEARCH_STATE_TYPE		{ABORT=1<<0, STOP=1<<1, FOLLOW_PV=1<<2,} SEARCH_STATE;			// Estados de la búsqueda
typedef	enum		ENGINE_STATE_TYPE		{SEARCHING=1<<0, PONDERING=1<<1, ANALYZING=1<<2,} ENGINE_STATE;	// Estados del motor
