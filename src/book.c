...
// Convierte a caracteres un movimiento del libro
...
MOVE	CheckBook(U64 key)		{
	...
	// Convirtiendo a caracteres y luego al formato interno del motor el movimiento del libro
