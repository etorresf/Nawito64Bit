...
#define				ROOK_MOVES_BB(SQ, ALL_PIECES)	(MagicMoveR[SQ][(int)((((ALL_PIECES) & RoccupancyMask[SQ]) * MagicRnumber[SQ]) >> MagicNumShiftR[SQ])])
#define				BISHOP_MOVES_BB(SQ, ALL_PIECES)	(MagicMoveB[SQ][(int)((((ALL_PIECES) & BoccupancyMask[SQ]) * MagicBnumber[SQ]) >> MagicNumShiftB[SQ])])
#define				QUEEN_MOVES_BB(SQ, ALL_PIECES)	(ROOK_MOVES_BB(SQ, ALL_PIECES) | BISHOP_MOVES_BB(SQ, ALL_PIECES))
...
static const BITBOARD	SquareKingCasttleBB[2]	= {0x6000000000000000L, 0x60L};
static const BITBOARD	SquareQueenCasttleBB[2]	= {0xE00000000000000L, 0xEL};
