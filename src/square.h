...
extern int			Distance[64][64];							// Distancias manhattan entre casillas
extern int			DistanceLineal[64][64];						// Distancias lineales entre casillas
extern int			DistanceCenter[64];							// Distancias manhattan al centro del tablero
extern int			DistanceCenterFile[64];						// Distancias manhattan a las columnas centrales
extern int			DistanceCasttle[64];						// Distancias manhattan a la ultimas filas
#define				DISTANCE_LAST_RANK(sq)		(RANK(sq))		// Distancias a la ultima fila del tablero, punto de vista NEGRO
